...
char *cpu_6502_instruction_set[] = {
     ...
     ** Info from: https://www.masswerk.at/nowgobang/2021/6502-illegal-opcodes
     */
    "SLO",      "(%i8,X)",      "x03 %i8",
    "SLO",      "(%i8),Y",      "x13 %i8",
    "RLA",      "(%i8,X)",      "x23 %i8",
...
char *cpu_z80_instruction_set[] = {
    ...
    "LD",       "A,IXH",        "xdd x7c",
    "LD",       "A,IXL",        "xdd x7d",
    "LD",       "IXH,%i8",      "xdd x26 %i8",
    "LD",       "IXL,%i8",      "xdd x2e %i8",
    "ADD",      "A,IXH",        "xdd x84",
    "ADD",      "A,IXL",        "xdd x85",
    "ADC",      "A,IXH",        "xdd x8c",
    "ADC",      "A,IXL",        "xdd x8d",
    ...
    "ADD",      "IX,IX",        "xdd x29",
    "DEC",      "IX",           "xdd x2b",
    "INC",      "(IX%d8)",      "xdd x34 %d8",
    "DEC",      "(IX%d8)",      "xdd x35 %d8",
    "ADD",      "IX,SP",        "xdd x39",
    ...
    "LD",       "A,IYH",        "xfd x7c",
    "LD",       "A,IYL",        "xfd x7d",
    "LD",       "IYH,%i8",      "xfd x26 %i8",
    "LD",       "IYL,%i8",      "xfd x2e %i8",
    "ADD",      "A,IYH",        "xfd x84",
    "ADD",      "A,IYL",        "xfd x85",
    "ADC",      "A,IYH",        "xfd x8c",
    "ADC",      "A,IYL",        "xfd x8d",
    ...
    "ADD",      "IY,IY",        "xfd x29",
    "DEC",      "IY",           "xfd x2b",
    "INC",      "(IY%d8)",      "xfd x34 %d8",
    "DEC",      "(IY%d8)",      "xfd x35 %d8",
    "ADD",      "IY,SP",        "xfd x39",
